...
Calculates time-weighted means of tick and liquidity for a given TideSwap V3 pool
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| pool | address | Address of TideSwap V3 pool that we want to observe |
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| pool | address | Address of TideSwap V3 pool |
