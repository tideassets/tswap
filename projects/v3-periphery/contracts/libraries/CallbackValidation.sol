...
/// @notice Provides validation for callbacks from TideSwap V3 Pools
library CallbackValidation {
    /// @notice Returns the address of a valid TideSwap V3 Pool
    /// @param deployer The contract address of the TideSwap V3 Deployer
