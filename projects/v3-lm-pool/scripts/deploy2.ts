...
import fs from 'fs'
import { abi } from '@tideswap/v3-core/artifacts/contracts/PancakeV3Factory.sol/PancakeV3Factory.json'
...
async function main() {
  ...
  const mcV3DeployedContracts = await import(`@tideswap/masterchef-v3/deployments/${networkName}.json`)
